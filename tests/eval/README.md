...
All three use the same Habr long-read profile (3 000–6 000 words, Russian-speaking backend engineers)
...
`tests/unit/pipeline/{clarify-brief,propose-angles,build-plan}.test.ts`.
